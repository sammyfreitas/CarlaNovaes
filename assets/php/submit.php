...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="carla.seavon@gmail.com";  // Your Mail
	$mail->Password="Your App Password"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("carla.seavon@gmail.com", "Carla Novaes Silva"); // (Your Mail) An email address that will receive the email with the output of the form

	$mail->IsHTML(true); // Set email format to HTML

	$mail->Subject = "(Carla) Contato!";
	$mail->Body = $html;
